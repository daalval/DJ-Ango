...
def get_result():
    ...
    result = query("https://ieeexploreapi.ieee.org/api/v1/search/articles?parameter&apikey=efv84mzqq6ydx4dbd59jhdcn", 'static/ieeeXplore.json', [LIBRO,COM_CON,ARTICULO], '1000', '2020')
