...
def select_data_fechas_tipos(fecha_desde, fecha_hasta, tipos):
    con = sql_connection()
    cursor = con.cursor()
    ...
    for tipo in tipos:
        if tipo == 'bbdd_articulo':
            ...
            INNER JOIN bbdd_revista AS r
            ON e.revista_id = r.id_revista
            WHERE anyo >= ''' + fecha_desde + ''' AND anyo <= ''' + fecha_hasta
...
def select_data_titulo_tipos(mi_titulo, tipos):
    con = sql_connection()
    cursor = con.cursor()
...
def select_data_autor_tipos(autor, tipos):
    con = sql_connection()
    cursor = con.cursor()
    ...
    for tipo in tipos:
        if tipo == 'bbdd_articulo':
            ...
            INNER JOIN bbdd_revista AS r
            ON e.revista_id = r.id_revista
            WHERE persona.nombre LIKE '%''' + autor + '''%' OR
...
def select_data_autor_fechas_tipos(autor, fecha_desde, fecha_hasta, tipos):
    con = sql_connection()
    cursor = con.cursor()
    ...
    for tipo in tipos:
        if tipo == 'bbdd_articulo':
            ...
            ON e.revista_id = r.id_revista
            WHERE (persona.nombre LIKE '%''' + autor + '''%' OR
            persona.apellidos LIKE '%''' + autor + '''%') AND
            (anyo >= ''' + fecha_desde + ''' AND anyo <= ''' + fecha_hasta +''')
            '''
...
def select_data_titulo_fechas_tipos(titulo, fecha_desde, fecha_hasta, tipos):
    con = sql_connection()
    cursor = con.cursor()
...
def select_data_titulo_autor_fechas_tipos(titulo, autor, fecha_desde, fecha_hasta, tipos):
    con = sql_connection()
    cursor = con.cursor()
...
def main():
    ...
    select_data_tipos(['bbdd_articulo', 'bbdd_com_con', 'bbdd_libro'])
    select_data_fechas_tipos('2000', '2020', ['bbdd_articulo', 'bbdd_com_con', 'bbdd_libro'])
    select_data_titulo_tipos('form', ['bbdd_articulo', 'bbdd_com_con', 'bbdd_libro'])
    select_data_autor_tipos('ang', ['bbdd_articulo', 'bbdd_com_con', 'bbdd_libro'])
    select_data_autor_fechas_tipos('ang', '2016', '2020', ['bbdd_articulo', 'bbdd_com_con', 'bbdd_libro'])
    select_data_titulo_fechas_tipos('form', '2013', '2020', ['bbdd_articulo', 'bbdd_com_con', 'bbdd_libro'])
    select_data_titulo_autor_fechas_tipos('form', 'ang', '2012', '2020', ['bbdd_articulo', 'bbdd_com_con', 'bbdd_libro'])
